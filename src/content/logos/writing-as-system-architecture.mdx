...
*For the system's approach to distribution, see [The Distribution Problem](/portfolio/logos/the-distribution-problem/). For the community infrastructure, see [Community Infrastructure for One](/portfolio/logos/community-infrastructure-for-one/).*
