...
<ShibuiContent id="what-ive-done.wrong-question.p1">
<span slot="entry">
<p>I spent years trying to construct a self-concept that would survive contact with the world. The answer is that self-concept is irrelevant. What I have done is what I am. The portfolio is proof. Narrative is cheap. This essay is about closing the gap between identity and evidence by pointing at what is already built.</p>
</span>
<span slot="elevated">
...
<ShibuiContent id="what-ive-done.three-thousand.p1">
<span slot="entry">
<p>I applied to roughly 3,000 jobs over several years — 1,000 teaching positions and 2,000 marketing and UX roles. I was qualified for all of them. I did not want any of them. What I wanted was to build creative systems, and that does not fit on a job application. Imposter syndrome is not feeling unqualified. It is applying to the wrong category, knowing it, and doing it anyway because rent is due.</p>
</span>
<span slot="elevated">
...
<ShibuiContent id="what-ive-done.evidence.p1">
<span slot="entry">
<p>The organvm system is the evidence. Not evidence that I am an artist — that is a narrative claim. Evidence that I can sustain creative practice at institutional scale. 97 repositories, 8 organizations, 404,000+ words of documentation. None of this is how I think of myself. All of it is what I built.</p>
</span>
<span slot="elevated">
