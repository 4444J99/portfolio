...
<ShibuiContent id="five-years.intro.p1">
<span slot="entry">
<p>There is a confusion unique to builders: standing in front of everything you have made and being unable to explain what it amounts to. I build at the intersection of theory, art, and commerce. The list of projects kept growing. The coherence did not. This is the story of five years spent turning chaos into a system.</p>
</span>
<span slot="elevated">
...
<ShibuiContent id="five-years.intro.p2">
<span slot="entry">
<p>I went from a chaotic GitHub account to an eight-organ system coordinating 79 repositories across 8 organizations, governed by a constitution and documented at portfolio grade. It took five years and several painful mistakes. The hardest part of creative work is not making things — it is making them legible.</p>
</span>
<span slot="elevated">
...
<ShibuiContent id="five-years.taxonomies.p1">
<span slot="entry">
<p>I tried every standard way to organize my work: by language, by function, by naming conventions, by tags, by spreadsheets. Nothing stuck. The key lesson was that developer categories like "library" or "frontend" describe implementation, not meaning. Creative work organizes along conceptual lines that those categories cannot capture.</p>
</span>
<span slot="elevated">
