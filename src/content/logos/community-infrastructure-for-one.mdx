...
*This essay is the first in the ORGANVM series to focus on ORGAN-VI (Koinonia), the community layer. For the distribution layer, see [The Distribution Problem](/portfolio/logos/the-distribution-problem/).*
