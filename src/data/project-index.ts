...
export const projectIndex: ProjectEntry[] = [
  ...
  { slug: 'linguistic-atomization', title: 'LingFrame', tags: ['Theory', 'Language'] },
  { slug: 'metasystem-master', title: 'Omni-Dromenon Engine', tags: ['Art', 'TypeScript', 'Python', 'Architecture'] },
  { slug: 'narratological-lenses', title: 'Narratological Lenses', tags: ['Theory', 'Narrative'] },
  { slug: 'orchestration-hub', title: 'Orchestration Hub', tags: ['Governance', 'Python', 'Systems'] },
  { slug: 'org-architecture', title: 'Org Architecture', tags: ['Systems', 'Community'] },
