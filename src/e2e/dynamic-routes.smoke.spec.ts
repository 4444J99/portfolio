...
const targets = JSON.parse(readFileSync(resolve(__dirname, '../data/targets.json'), 'utf-8')) as { targets: { slug: string }[] };
const personas = JSON.parse(readFileSync(resolve(__dirname, '../data/personas.json'), 'utf-8')) as { personas: { slug: string }[] };
