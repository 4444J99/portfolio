...
const minCoverage =
	minCoverageOverride === null ? resolvedCoverage.minCoveragePct : Number(minCoverageOverride);
...
const routesCovered =
	typeof runtimeSummary.pagesAudited === 'number' ? runtimeSummary.pagesAudited : 0;
